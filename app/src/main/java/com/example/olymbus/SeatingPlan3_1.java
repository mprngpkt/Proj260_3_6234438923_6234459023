...
public class SeatingPlan3_1 extends Fragment {
    //int cntSelected=0;
    Button btnBack;
    Button btnBook;
...
//ลอง
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                TimeTableForSwimming timeTableForSwimming = new TimeTableForSwimming();
                FragmentTransaction fragmentTransaction = getFragmentManager().beginTransaction();
                fragmentTransaction.replace(R.id.fragment_container, timeTableForSwimming).commit();
