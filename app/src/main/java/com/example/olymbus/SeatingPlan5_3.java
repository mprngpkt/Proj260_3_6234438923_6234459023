...
public class SeatingPlan5_3 extends Fragment {
    //int cntSelected=0;
    Button btnBack;
    Button btnBook;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.layout_seatingplan, container, false);
            ...
            textView1.setText("Bus 3");
            TextView textdetail = (TextView) v.findViewById(R.id.text_detail);
            textdetail.setText("Destination : Tokyo International Forum \n Depart : 12.00");
...
//ลอง
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                TimeTableForWeightLifting timeTableForWeightLifting = new TimeTableForWeightLifting();
                FragmentTransaction fragmentTransaction = getFragmentManager().beginTransaction();
                fragmentTransaction.replace(R.id.fragment_container, timeTableForWeightLifting).commit();
